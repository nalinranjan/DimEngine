...
DimEngine::Rendering::ShadowMap::ShadowMap() {
	//texture2d desc
	shadowDesc = {};
...
void DimEngine::Rendering::ShadowMap::setUp(ID3D11Device* device) {
...
void DimEngine::Rendering::ShadowMap::setShader(SimpleVertexShader * _shadowShader)
{
...
ID3D11DepthStencilView * DimEngine::Rendering::ShadowMap::getShadowDSV() {
...
ID3D11RasterizerState * DimEngine::Rendering::ShadowMap::getRasterizerState() {
	return shadowRasterizerState;
}

ID3D11ShaderResourceView * DimEngine::Rendering::ShadowMap::getShadowSRV() {
	return shadowResourceView;
}

ID3D11SamplerState * DimEngine::Rendering::ShadowMap::getSampler() {
	return shadowSampler;
}

SimpleVertexShader * DimEngine::Rendering::ShadowMap::getShadowShader()
{
	return shadowShader;
}
