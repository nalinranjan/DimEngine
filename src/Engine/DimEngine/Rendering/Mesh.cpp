...
DimEngine::Rendering::Mesh::Mesh(Vertex* vertices, int verticesNumber, unsigned int* indices, int indicesNumber, ID3D11Device* device)
{
...
void DimEngine::Rendering::Mesh::operator delete(void * p)
{
