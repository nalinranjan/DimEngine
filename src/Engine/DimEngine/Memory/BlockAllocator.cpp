...
DimEngine::Memory::BlockAllocator::BlockAllocator()
{
	memory = nullptr;
	capacity = 0;
	this->size = 0;
...
DimEngine::Memory::BlockAllocator::BlockAllocator(size_t size)
{
...
void* DimEngine::Memory::BlockAllocator::Allocate(size_t size)
{
...
void DimEngine::Memory::BlockAllocator::Free(void* p)
{
...
void DimEngine::Memory::BlockAllocator::Add(Block * block)
{
...
void DimEngine::Memory::BlockAllocator::Remove(Block * block)
{
