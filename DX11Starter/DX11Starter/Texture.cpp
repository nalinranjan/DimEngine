...
Texture::Texture(wchar_t* _filepath, D3D11_TEXTURE_ADDRESS_MODE _addressMode, D3D11_FILTER _filterMode, float _maxLOD, ID3D11Device* _device, ID3D11DeviceContext* _context) {
